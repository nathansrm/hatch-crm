---
title: Migrations
description: This document explains how to create and manage database migrations in Hatch CRM.
---

Hatch CRM uses [declarative database schemas](https://supabase.com/docs/guides/local-development/declarative-database-schemas) to manage its database structure. The schema is defined in `.sql` files under `supabase/schemas/`, and migrations are auto-generated from those files.
...
If you change the data structure for a contact, don't forget to modify the sample CSV file located at [`src/components/hatch-crm/contacts/contacts_export.csv`](https://github.com/hatchtheory/hatch-crm/blob/main/src/components/hatch-crm/contacts/contacts_export.csv). You'll also need to modify the import function found in [`src/components/hatch-crm/contacts/useContactImport.tsx`](https://github.com/hatchtheory/hatch-crm/blob/main/src/components/hatch-crm/contacts/useContactImport.tsx).
