...
description: This document explains how to import and export contacts in Hatch CRM.
---

Whether you are starting to use Hatch CRM, or want to migrate from another CRM, you can import your contacts, companies, tasks, notes, tags and deals in a few clicks. You can also export your contacts and companies in CSV format, and your contacts as vCard files.

## Import Contacts From CSV

Hatch CRM displays an import contact buttons in the initial user onboarding page, and in the contacts page. When clicking on it, a modal is displayed to upload a CSV file.

<video
    src="https://github.com/user-attachments/assets/a1133cf0-0287-4fc0-b61b-5a0b88617cfc"
    controls
    className="w-full aspect-1304/814"
></video>
...
Hatch CRM allows to import contacts, companies, tasks, notes, tags and deals from a single JSON file. You can create this JSON file from the export of your previous CRM. The expected format of the JSON file looks like the following:
...
This migration tool will allow you to easily migrate from your previous CRM to Hatch CRM, and start using it in a few clicks.
