...
description: This document explains how to configure Hatch CRM.
---

Admin users can configure various aspects of Hatch CRM to tailor the application to their specific needs. This includes customizing the user interface, defining categories, etc.
