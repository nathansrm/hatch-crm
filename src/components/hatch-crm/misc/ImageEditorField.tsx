    ...
    <Dialog open={props.open} onOpenChange={props.onClose}>
      ...
      <DialogContent>
        ...
        <div className="flex flex-col gap-2 justify-center">
          <div
            className="flex flex-row justify-center bg-muted/30 cursor-pointer p-4 border-2 border-dashed border-border rounded-lg hover:bg-muted/50 transition-colors"
            {...getRootProps()}
          >
            <input {...getInputProps()} />
