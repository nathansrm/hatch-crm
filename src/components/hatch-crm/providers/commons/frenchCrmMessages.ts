...
export const frenchCrmMessages = {
  ...
  resources: {
    ...
    intake_leads: {
      ...
      fields: {
        ...
        city: "Ville",
        region: "Région",
        trade_type_id: "Type de métier",
        enrichment_summary: "Enrichissement IA",
        outreach_draft: "Brouillon de prospection",
        source: "Source",
        status: "Statut",
      ...
      empty: {
        ...
        description: "Les nouveaux prospects apparaîtront ici à leur arrivée.",
        no_match_title: "Aucun prospect ne correspond à ces filtres",
        no_match_description: "Ajustez vos filtres pour élargir la recherche.",
      },
      error: {
        title: "Erreur lors du chargement des prospects",
      ...
      rejection_reasons: {
        not_a_fit: "Ne correspond pas",
        duplicate: "Doublon",
        no_contact_info: "Pas de coordonnées",
        out_of_area: "Hors zone",
        other: "Autre",
      },
      expanded: {
        enrichment: "Enrichissement IA",
        outreach: "Brouillon de prospection",
        location: "Emplacement",
        notes: "Notes",
        no_details: "Aucun détail supplémentaire pour le moment.",
      },
      notify: {
        promoted: "Prospect promu avec succès",
        promote_failed: "Échec de la promotion du prospect",
        rejected: "Prospect rejeté",
        reject_failed: "Échec du rejet du prospect",
        batch_rejected: "Les prospects sélectionnés ont été rejetés",
        batch_reject_failed: "Échec du rejet des prospects",
      },
    },
    tags: {
  ...
  crm: {
    ...
    auth: {
      ...
      welcome_title: "Bienvenue sur Hatch Theory Solutions",
    },
    common: {
      activity: "Activité",
      added: "ajoutée",
    ...
    dashboard: {
      ...
      stepper: {
        install: "Installer Hatch Theory Solutions",
