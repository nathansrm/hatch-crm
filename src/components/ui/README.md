...
In Hatch CRM, these components are sometimes slightly modified to fit the look and feel of the application. You can customize them further by editing the source files in this directory.

## Updates

Shadcn/ui components are actively maintained and updated. To add or update a UI component in Hatch CRM, type the following command:
