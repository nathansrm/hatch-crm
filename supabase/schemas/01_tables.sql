...
create table public.deals (
    ...
    software_stack text[],
    dm_present boolean,
    hours_wasted_per_week numeric,
    response_time_hours numeric,
    projected_hours numeric,
    project_status text check (project_status in ('on_track', 'at_risk', 'behind', 'complete') or project_status is null),
    project_progress_pct integer check (project_progress_pct >= 0 and project_progress_pct <= 100),
...
create table public.agency_settings (
    ...
    won_goal integer not null default 10,
    updated_at timestamptz default now(),
    check (id = 1)
);
...
create table public.intake_leads (
    ...
    current_draft_status text default 'none'
...
create table public.outreach_steps (
    id bigint generated by default as identity primary key,
    intake_lead_id uuid not null references public.intake_leads(id) on delete cascade,
